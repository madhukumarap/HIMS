...
const MedicineAdministrationReport = db.medicineAdmin;
...
const PrescriptionupdateMedicines = async (req, res) => {
  try {
    ...
    for (const medicine of updatedMedicines) {
      ...
      const { id, medicineName, quantity, dosageAmount, startDate, food, weekly, timing, InventoryitemNameID } = medicine;
