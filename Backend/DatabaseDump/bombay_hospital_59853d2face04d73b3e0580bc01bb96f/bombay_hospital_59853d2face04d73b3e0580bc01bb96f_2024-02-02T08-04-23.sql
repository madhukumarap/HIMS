...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: naresultmodeldiagnostics
# ------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `naresultmodeldiagnostics` (
  `id` int NOT NULL AUTO_INCREMENT,
  `PatientID` int NOT NULL,
  `TestManagementID` int NOT NULL,
  `Comment` longtext,
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: nasresultmodeldiagnostics
# ------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `nasresultmodeldiagnostics` (
  `id` int NOT NULL AUTO_INCREMENT,
  `PatientID` int NOT NULL,
  `TestManagementID` int NOT NULL,
  `Comment` longtext,
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: test1resultmodels
# ------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `test1resultmodels` (
  `id` int NOT NULL AUTO_INCREMENT,
  `PatientID` int NOT NULL,
  `TestManagementID` int NOT NULL,
  `Comment` longtext,
  `PatientTestBookingID` int NOT NULL,
  `axaaS` varchar(255) DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: testresultmodels
# ------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `testresultmodels` (
  `id` int NOT NULL AUTO_INCREMENT,
  `PatientID` int NOT NULL,
  `TestManagementID` int NOT NULL,
  `Comment` longtext,
  `PatientTestBookingID` int NOT NULL,
  `xaasxasx` varchar(255) DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: xsaxresultmodels
# ------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `xsaxresultmodels` (
  `id` int NOT NULL AUTO_INCREMENT,
  `PatientID` int NOT NULL,
  `TestManagementID` int NOT NULL,
  `Comment` longtext,
  `PatientTestBookingID` int NOT NULL,
  `xsxsxs` varchar(255) DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
VALUES
  (
    1,
    'bombay_hospital_59853d2face04d73b3e0580bc01bb96f_2024-01-30T11-52-23.sql',
    'C:\\Users\\dhira\\OneDrive\\Desktop\\INTERNSHIP TASKS\\mediAI\\pharmacymanagement\\HIMS\\Backend\\DatabaseDump\\bombay_hospital_59853d2face04d73b3e0580bc01bb96f\\bombay_hospital_59853d2face04d73b3e0580bc01bb96f_2024-01-30T11-52-23.sql',
...
VALUES
  (
    2,
    'bombay_hospital_59853d2face04d73b3e0580bc01bb96f_2024-01-30T13-08-15.sql',
    'C:\\Users\\dhira\\OneDrive\\Desktop\\INTERNSHIP TASKS\\mediAI\\pharmacymanagement\\HIMS\\Backend\\DatabaseDump\\bombay_hospital_59853d2face04d73b3e0580bc01bb96f\\bombay_hospital_59853d2face04d73b3e0580bc01bb96f_2024-01-30T13-08-15.sql',
    'Hospital Administrator',
    'restored',
    '2024-01-30 13:08:16',
    '2024-01-30 14:21:50'
...
VALUES
  (
    3,
    'bombay_hospital_59853d2face04d73b3e0580bc01bb96f_2024-01-30T14-26-26.sql',
    'C:\\Users\\dhira\\OneDrive\\Desktop\\INTERNSHIP TASKS\\mediAI\\pharmacymanagement\\HIMS\\Backend\\DatabaseDump\\bombay_hospital_59853d2face04d73b3e0580bc01bb96f\\bombay_hospital_59853d2face04d73b3e0580bc01bb96f_2024-01-30T14-26-26.sql',
    'Hospital Administrator',
    'restored',
    '2024-01-30 14:26:28',
    '2024-01-30 15:18:27'
...
VALUES
  (
    4,
    'bombay_hospital_59853d2face04d73b3e0580bc01bb96f_2024-01-30T15-18-37.sql',
    'C:\\Users\\dhira\\OneDrive\\Desktop\\INTERNSHIP TASKS\\mediAI\\pharmacymanagement\\HIMS\\Backend\\DatabaseDump\\bombay_hospital_59853d2face04d73b3e0580bc01bb96f\\bombay_hospital_59853d2face04d73b3e0580bc01bb96f_2024-01-30T15-18-37.sql',
    'Hospital Administrator',
    'restored',
    '2024-01-30 15:18:37',
    '2024-01-30 15:18:44'
...
VALUES
  (
    ...
    'xaxasx',
    '',
    'Seed Infotech Ltd, Kesnand Phata, Wagholi',
    'sASas',
    'company@gmauil.com',
    '',
    X'',
...
VALUES
  (
    ...
    'Mahadik',
    '1234',
    'dhirajmahadik9221@gmail.com',
    'Flat No 302, Seed Infotech Ltd, Kesnand Phata, Wagholi',
    9192845933,
    '2024-01-31 06:44:14',
    NULL,
    '2024-01-31 06:44:14'
...
# ------------------------------------------------------------
# DATA DUMP FOR TABLE: naresultmodeldiagnostics
# ------------------------------------------------------------


# ------------------------------------------------------------
# DATA DUMP FOR TABLE: nasresultmodeldiagnostics
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# DATA DUMP FOR TABLE: test1resultmodels
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# DATA DUMP FOR TABLE: testresultmodels
# ------------------------------------------------------------
...
VALUES
  ('2024-01-30 11:47:20', '2024-01-30 11:47:20', 10, 1);
...
VALUES
  (
    ...
    0,
    1234567890,
    '$2a$08$TDkhamaO7DaDOVMaiQqE4ezqKF97xawb4sgh6iqpQ6uRb.i9mnPMG',
    'en',
    'active',
    '2024-01-30 11:47:20',
    '2024-01-31 05:57:18'
...
# ------------------------------------------------------------
# DATA DUMP FOR TABLE: xsaxresultmodels
# ------------------------------------------------------------
