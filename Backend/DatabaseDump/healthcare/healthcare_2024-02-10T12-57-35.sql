...
CREATE TABLE IF NOT EXISTS `hospitals` (
  ...
  UNIQUE KEY `HospitalUserName_18` (`HospitalUserName`),
  UNIQUE KEY `HospitalID_MainDatabase_18` (`HospitalID_MainDatabase`),
  UNIQUE KEY `HospitalGUID_18` (`HospitalGUID`),
  UNIQUE KEY `HospitalUserName_19` (`HospitalUserName`),
  UNIQUE KEY `HospitalID_MainDatabase_19` (`HospitalID_MainDatabase`),
  UNIQUE KEY `HospitalGUID_19` (`HospitalGUID`),
  UNIQUE KEY `HospitalUserName_20` (`HospitalUserName`),
  UNIQUE KEY `HospitalID_MainDatabase_20` (`HospitalID_MainDatabase`),
  UNIQUE KEY `HospitalGUID_20` (`HospitalGUID`),
  UNIQUE KEY `HospitalUserName_21` (`HospitalUserName`),
  UNIQUE KEY `HospitalID_MainDatabase_21` (`HospitalID_MainDatabase`),
  UNIQUE KEY `HospitalGUID_21` (`HospitalGUID`)
) ENGINE = InnoDB AUTO_INCREMENT = 2 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
