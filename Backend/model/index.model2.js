...
let Database = require("../model/index.model.js");

const { Sequelize, DataTypes } = require("sequelize");

const db = {};

const CreateDatabaseandTables = (database, hospitalNamewithdot) => {
  let sequelize = new Sequelize(database, dbConfig.USER, dbConfig.PASSWORD, {
    host: dbConfig.HOST,
