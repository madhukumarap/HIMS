...
const getConnection = async (database) => {
  ...
  try {
    ...
    db.BedsHospitalRoom = require("./BedsHospitalRoom.js")(
      sequelize,
      DataTypes
    );
    ...
    db.HospitalAdmission = require("./HospitalAdmission.js")(
      sequelize,
      DataTypes
    );
    ...
    db.CompanyItem = require("./Inventory/CompanyItem.js")(
      sequelize,
      DataTypes
    );
    ...
    db.PathologyTestManage = require("./PathologyTestManage")(
      sequelize,
      DataTypes
    );
    ...
    db.CompanyRegistration = require("./CompanyRegistration")(
      sequelize,
      DataTypes
    );
    ...
    db.DoctorsAppointment = require("./DoctorsAppointment")(
      sequelize,
      DataTypes
    );
    ...
    db.dailyQuantityOut = require("./DailyQuantityOutReport")(
      sequelize,
      DataTypes
    );
    ...
    db.BloodSugarForFasting =
      require("./PathologyTestAllModel/BloodSugarForFasting")(
        sequelize,
        DataTypes
      );
    ...
    async function initial() {
      try {
        ...
        const rolesToCreate = [
          ...
          (role) =>
            !existingRoles.find(
              (existingRole) => existingRole.role === role.role
            )
        );
...
module.exports = {
  getConnectionList: getConnection,
};
