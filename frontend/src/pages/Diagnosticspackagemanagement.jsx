...
const Diagnosticspackagemanagement = () => {
  ...
  const handleSave = () => {
    ...
    if (!selectedPackageID) {
      ...
      axios
        .post(
          `${import.meta.env.VITE_API_URL}/api/diagnosticscreatePackageTest`,
          postData,
          {
            headers: {
              Authorization: `${currentUser?.Token}`,
      ...
      axios
        .put(
          `${import.meta.env.VITE_API_URL}/api/DiagnosticsUpdatePackageTest/${selectedPackageID}`,
          postData,
          {
            headers: {
              Authorization: `${currentUser?.Token}`,
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ fontSize: "16px" }}>{t("createPackageDiagnostics")} </h2>
      </header>
      <br></br>
      <Button
        style={{ fontSize: "12px" }}
...
export default Diagnosticspackagemanagement;
