...
function Pathologytest() {
  ...
  const handleUpdateAuthorization = () => {
    ...
    axios
      .put(`${import.meta.env.VITE_API_URL}/api/updateAuthorization`, data, {
        headers: {
          Authorization: `${currentUser?.Token}`,
        },
      })
              ...
              <div className="col-md-6">
                <div className="form-group">
                  ...
                  <input
                    ...
                    value={(() => {
                      try {
                        const hasPackage = selectedPackageObject?.finalPrice;
                        const totalAmount = hasPackage
                          ? (parseFloat(selectedPackageObject.finalPrice) ||
                              0) + (parseFloat(formData.testFees) || 0)
                          : parseFloat(formData.testFees || 0) || 0;
