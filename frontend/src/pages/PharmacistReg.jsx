...
const PharmacistForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}/api/savePharmacist`,
        formData,
        {
          headers: {
  ...
  return (
    <Container style={style}>
      ...
      >
        <h2 style={h1Style}>{t("PharmacistRegistration")}</h2>
      </header>{" "}
      <br />
      <Card className="mt-12">
        <Card.Body>
          ...
          >
            {/* <h3 style={h1Style} className="mb-4">
          ...
          <Form onSubmit={handleSubmit}>
            <Row>
              <Col xs={12} sm={12} md={4}>
                <Form.Group className="d-flex align-items-center">
                  ...
                  />
                  {errors.firstName && (
                    <span className="text-danger">{t(errors.firstName)}</span>
                  )}
              ...
              <Col xs={12} sm={6} md={4}>
                <Form.Group className="d-flex align-items-center">
                  <Form.Control
                    ...
                    title={t("middleNamePattern")}
                  />
                  {errors.middleName && (
                    <span className="text-danger">{t(errors.middleName)}</span>
                  )}
                </Form.Group>
              </Col>
              <Col xs={12} sm={6} md={4}>
                <Form.Group className="d-flex align-items-center">
                  <Form.Control
                    ...
                    pattern="[A-Za-z ]+" // Allow only alphabetic characters and spaces
                    title={t("lastNamePattern")}
                    required
                  />
                  {errors.lastName && (
                    <span className="text-danger">{t(errors.lastName)}</span>
                  )}
                  <Form.Control.Feedback type="invalid">
                    {t(errors.lastName)}
                  </Form.Control.Feedback>
                ...
                <Form.Group className="d-flex align-items-center">
                  ...
                  {/* {formData.userName &&
                    (!/^(?=.*[A-Z])[A-Za-z][A-Za-z0-9]*$/i.test(
                      ...
                      formData.userName.length < 6) && (
                      <span className="text-danger">
                        Invalid username (must start with a letter, contain only
                        letters and numbers, be at least 6 characters long, and
                  ...
                  {formData.userName &&
                    ...
                    /^[a-z][a-z0-9]*$/i.test(formData.userName) && (
                      <span className="text-danger">
                        Invalid username (must contain at least one capital
                        letter)
                      </span>
                    )}
                  <Form.Control.Feedback type="invalid">
            ...
            <Row>
              <Col>
                {/* <Button
                                    style={{ fontSize: '12px', padding: '4px 5px', textAlign: 'center' }}
                                    variant="secondary"
                                    type="submit"
