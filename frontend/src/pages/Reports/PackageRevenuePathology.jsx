...
const PackageRevenuePathology = () => {
  ...
  const [allPathologyBookings, setAllPathologyBookings] = useState([]);
  ...
  const fetchAllPathologyBookings = () => {
    axios
      .post(
        `${import.meta.env.VITE_API_URL}/api/allPathologyTestData`,
  ...
  const fetchData = () => {
    ...
    if (selectedPackageId) {
      ...
      const url = `${import.meta.env.VITE_API_URL}/api/getAllPackageRevenue`;
  ...
  const getSelectedPackagePatients = (packageID) => {
    axios
      .get(
        `${
          import.meta.env.VITE_API_URL
        }/api/selectedPackagePatients/pathology/${packageID}`,
  ...
  const getPackageType = (corporateID) => {
    let type = undefined;

    companies.forEach((element) => {
      element.registrationNo == corporateID && (type = element.industryType);
    });
  ...
  return (
    <>
      ...
      >
        ...
        >
          <h2 style={{ fontSize: "18px" }}>{t("PackageRevenuePathology")}</h2>
        </header>
        <br></br>
                ...
                >
                  <Thead>
                    <Tr>
                      ...
                      <Th style={{ textAlign: "center" }}>{t("Sellcount")}2</Th>
                      <Th style={{ textAlign: "center" }}>
                        {t("PackageEarnings")}
                      </Th>
                    </Tr>
                  ...
                  <Tbody>
                    <Tr>
                      ...
                      <Td style={{ textAlign: "center", whiteSpace: "nowrap" }}>
                        {selectedPackage.finalPrice} {selectedPackage.Currency}{" "}
                      </Td>
                      <Td style={{ textAlign: "center", whiteSpace: "nowrap" }}>
        ...
        {console.log("selectedPackage: ", selectedPackage.Currency)}
        {!selectedPackageId && (
          <Card>
            <Card.Header>{t("SelectedPackageDetails")}</Card.Header>
            <Card.Body>
                    ...
                    {packageassociatedPatients.map((patient, index) => (
                      <Tr key={index}>
                        ...
                        <Td
                          style={{ textAlign: "center", whiteSpace: "nowrap" }}
                        >
                          {/* {patient.packagePrice} {patient.Currency} */}
                          {`${convertCurrency(
                        ...
                        >
                          {`${convertCurrency(
                            parseInt(patient.packageRevenue, 10),
                            patient?.Currency,
                            ""
                          )} ${selectedGlobalCurrency}`}
                        </Td>
          ...
          <Card.Body>
            <div className="table-responsive">
              ...
              >
                ...
                <Tbody>
                  {allPathologyBookings.length > 0 ? (
                    allPathologyBookings
...
export default PackageRevenuePathology;
