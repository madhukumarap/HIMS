...
import Translation from "../../translations/PatientTestHistory.json";
import { useTranslation } from "react-i18next";
import i18n from "i18next";
import { initReactI18next } from "react-i18next";

const PatientOwnTestHistory = () => {
  ...
  const handleDownload = () => {
    if (fetchedData.length === 0) {
      toast.error(t("NoresultsavailabletodownloadasPDF"));
    ...
    axios
      ...
      .then((response) => {
        if (response.data.length === 0) {
          ...
          toast.success(t("ResultFetchedSuccessfully"));
    ...
    >
      ...
      >
        <h2 style={{ fontSize: "18px" }}>
          {t("PatientTestHistory(Pathology)")}
        </h2>
      </header>
      <br></br>
      ...
      <div className="row mb-3">
        ...
        <div className="col-md-2">
          <label className="form-label">{t("SelectTest")}:</label>
          <select
            style={{
              fontSize: "14px",
            }}
          ...
          >
            <thead>
              <tr>
                ...
                >
                  {t("patienttestHistoryTable.SrNo")}
                </th>
                <th
                  rowSpan="2"
                  style={{ textAlign: "center", verticalAlign: "middle" }}
                >
                  {t("patienttestHistoryTable.TestName")}
                </th>
                <th
                  rowSpan="2"
                  style={{ textAlign: "center", verticalAlign: "middle" }}
                >
                  {t("patienttestHistoryTable.TestCompletedDate")}
                </th>
                <th colSpan={visibleFieldNames.length}>
                  {t("patienttestHistoryTable.Parameters")}
                </th>
              </tr>
...
export default PatientOwnTestHistory;
