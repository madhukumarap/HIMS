...
const PerVisitDiagnosticRevenue = () => {
  ...
  const fetchBookings = () => {
    const url = `${import.meta.env.VITE_API_URL}/api/getAllBookingsTestDiagnosticPerVisit`;
    axios
      .get(url, {
        headers: {
          "Content-Type": "application/json",
  ...
  const chartOptions = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: 'Diagnostic Revenue Over Time'
      },
    },
    scales: {
      y: {
    ...
    >
      ...
      >
        <h2 style={{ fontSize: "18px" }}>
          Patient Per Visit Revenue (Diagnostics)
        </h2>
      </header>
      <br></br>
...
export default PerVisitDiagnosticRevenue;