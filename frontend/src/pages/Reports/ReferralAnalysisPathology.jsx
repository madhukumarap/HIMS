...
const ReferralAnalysisPathology = () => {
  ...
  const fetchBookings = () => {
    ...
    if (selectedPatient) {
      ...
      const url = `${import.meta.env.VITE_API_URL}/api/getAllBookingsTestPathologyAllDoctorReferral`;
      // alert(SelectedDoctorID);
      axios
        .get(url, {
          params: {
  ...
  const fetchData = () => {
    const url = `${import.meta.env.VITE_API_URL}/api/getAllBookingsTest`;
    axios
      .get(url, {
        headers: {
          Authorization: `${currentUser?.Token}`,
  ...
  return (
    <div style={{ fontSize: "14px" }} className="container">
      ...
      >
        <h2 style={{ fontSize: "16px" }}>{t("ReferralAnalysisPathology")}</h2>
      </header>{" "}
      <br></br>
                ...
                >
                  ...
                  <Tbody>
                    <Tr>
                      ...
                      <Td style={{ textAlign: "center", whiteSpace: "nowrap" }}>
                        {currencySymbols[selectedGlobalCurrency]} {formatNumber(safeConvertCurrency(
                          bookings.reduce(
                            (total, booking) =>
      ...
      {/* Rest of your existing tables and components remain the same */}
      <br></br>
      {selectedDoctor && (
        <Card>
              ...
              >
                ...
                <Tbody>
                  <Tr>
                    ...
                    <Td style={{ textAlign: "center", whiteSpace: "nowrap" }}>
                      {bookingsObject?.totalTestFeesUSD} USD
                    </Td>
                  </Tr>
                </Tbody>
              </Table>
      ...
      {/* Existing tables for doctor details and patient data remain unchanged */}
      {!selectedPatient ? (
        <Card>
