...
const ViewMedicationReport = () => {
  ...
  if (prescriptionData) {
    if (currentUser.roles.includes("ROLE_ADMIN")) {
      goBackLink = `/${extractedPart}/adminReport`;
    } else if (currentUser.roles.includes("ROLE_DOCTOR")) {
      goBackLink = `/${extractedPart}/OnePatientPrescription/${prescriptionData.patient_Id}`;
    } else if (currentUser.roles.includes("ROLE_NURSE")) {
      goBackLink = `/${extractedPart}/NurseOnePatientPrescription/${prescriptionData.patient_Id}`;
    }
  }
  ...
  const handleDownloadPDF = async (
    ...
    const prescriptionTableData = [
      ...
      [t("clinicalDiagnosis"), prescriptionData.clinicalDiagnosis],
      [t("doctorName"), prescriptionData.PrescribedDoctor],
    ...
    const medicineTableData = [
      [t("medicationAdministrationRecordsTable.medicineName"), medicineName],
      [t("medicationAdministrationRecordsTable.dosageAmount"), dosageAmount],
      [
        t("medicationAdministrationRecordsTable.medicationAdvice"),
        medicationAdvice,
      ],
    ];
    ...
    doc.autoTable({
      ...
      head: [
        [
          t("medicationAdministrationRecordsTable.Date"),
                        ...
                        {limitedDates.map((date, dateIndex) => (
                          ...
                          >
                            ...
                            <td style={{ textAlign: "center" }}>
                              {formatDateInSelectedLanguage(new Date(date))}
                            </td>
                            <td style={{ textAlign: "center" }}>
                              {convertToIndianTime(
